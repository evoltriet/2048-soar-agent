...
public class Gui extends JPanel {
    ...
    private void createGUI() {
        ...
        agentAdvance = new JButton("Run 1000");
    ...
    private class ActionBindings extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(actionCommand.equals("R") || actionCommand.equals("Switch to Agent") || actionCommand.equals("Switch to Human")) {
                ...
                game.killSoar();
                System.exit(0);
            } else if(actionCommand.equals("Run 1000")) {
                int gameNumber = 0;
                int scoreAverage = 0;
                int valueAverage = 0;

                while(gameNumber < 9999) {
                    ...
                    System.out.println("Num " + gameNumber + "Highest Score: " + game.score() + " highest value: " + game.highestValue());
                ...
                System.out.println("Score averge value: " + valueAverage / 25); 
